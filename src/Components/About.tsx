...
const About = () => {
    ...
    return (
        <section className="agency agency-content about-bg" id='about'>
                    ...
                    <Col xl="9" md="9"  className="offset-xl-3 offset-md-3">
                        <div className="agency-header-center-container">
                            ...
                            <div className="agency-head">
                                <h3 className="agency-head-text">Who we are
                                    {/* <span className="block-span">For Made Your Idea</span> */}
                                </h3>
                            </div>
                        </div>
    
                        <p className="agency-para">We are here Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                            do eiusm od tempor
                            incididunt
